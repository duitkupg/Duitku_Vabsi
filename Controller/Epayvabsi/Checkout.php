 ...
 *
 */
namespace Duitku\Vabsi\Controller\Epayvabsi;
use Magento\Framework\Controller\ResultFactory;

class Checkout extends \Duitku\Vabsi\Controller\AbstractActionController
{
    /**
     * Checkout Action
     */
    public function execute()
    {
    	 $obj = \Magento\Framework\App\ObjectManager::getInstance();
    	  ...
    	  $paymentmode = $this->_scopeConfig->getValue('payment/duitku_vabsiepay/payment_mode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    	 if($paymentmode =='1')
    	 {
        ...
        $helper = $obj->get('Duitku\Vabsi\Helper\Data');
