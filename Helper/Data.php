...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @param \Duitku\Vabsi\Logger\DuitkuLogger $duitkuLogger
     * @param \Magento\Framework\Encryption\EncryptorInterface $encryptor
     * @param \Magento\Framework\Module\ModuleListInterface $moduleList
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Duitku\Vabsi\Logger\DuitkuLogger $duitkuLogger,
    ...
    {
        return $this->getConfigData($field, 'duitku_vabsiepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Vabsi_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_Vabsi")['setup_version'];
    }
     ...
     *
     * @param \Duitku\Vabsi\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
